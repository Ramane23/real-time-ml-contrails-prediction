...
export KAFKA_CONSUMER_GROUP="historical_flights_with_weather_consumer_primary_keys"
...
export FEATURE_GROUP_NAME="historical_flights_tracking_with_weather_data"
